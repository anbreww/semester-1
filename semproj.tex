...
% todo : example use case? light switch on a desk or close to a home
% entertainment system. monitor the temperature/humidity in a wine cellar.
% detect people arriving at the door
...
% TODO : get some data for self-discharge
\begin{table}
  \centering
...
of the XMEGA software framework\furl{http://asf.atmel.no/xmega/readme.html}
