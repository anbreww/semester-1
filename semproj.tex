...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=1.0\textwidth]{flowcharts/topology-flows}
  \end{center}
...
Capacitive humidity sensor: calculate proper resistor
...
% todo : replace initial_tests with motion-board
\bash{main.c}
\lstinputlisting[language=C]{../code/initial_tests/main.c}
...
% todo : replace initial_tests with dimmer-board
\bash{main.c}
\lstinputlisting[language=C]{../code/initial_tests/main.c}
...
% todo : replace initial_tests with sensors-board
\bash{main.c}
\lstinputlisting[language=C]{../code/initial_tests/main.c}
...
\subsubsection{Environment sense main file}
% todo : replace initial_tests with gateway
\bash{gateway.c}
